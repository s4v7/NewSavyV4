...
local getcustomassets = {
	...
	['newvape/assets/new/guivape.png'] = 'rbxassetid://111315220246637',
	...
	['newvape/assets/new/textvape.png'] = 'rbxassetid://100463957550090',
...
general:CreateButton({
	...
	mainapi.Save = function() end
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/pxzw/savyv4/'..readfile('newvape/profiles/commit.txt')..'/loader.lua', true))()
		end
	end,
